...
public class AcercaDeActivity extends GDActivity {
	
	@Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setActionBarContentView(R.layout.acercade_activity);
        
        ActionBar ab = getActionBar();
        Typeface fontFace = Typeface.createFromAsset(getAssets(), "fonts/chris.ttf");
        //Trabajoab.setTypeFace(fontFace, 26.f);
        ab.setTitle(getString(R.string.acercade_acercade));
    }
