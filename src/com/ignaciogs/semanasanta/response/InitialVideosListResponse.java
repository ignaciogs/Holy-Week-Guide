 ...
 */
public class InitialVideosListResponse implements Serializable  {

    private String apiVersion;

    private VideosListResponse data;
    ...
    public VideosListResponse getData() {
        return data;
    }

    public void setData(VideosListResponse data) {
        this.data = data;
    }
}
